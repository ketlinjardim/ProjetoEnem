    ...
    <View style={estilo.root}>
      ...
      <View style={estilo.espacopv}>
        <View style={estilo.espacobt}>
          ...
          <Pressable style={estilo.butao}>
            <Text style={estilo.textinho}>Provas</Text>
          </Pressable>
          <Pressable style={estilo.butao}>
            <Text style={estilo.textinho}>Informações gerais</Text>
          </Pressable>
          <Pressable style={estilo.butao}>
            <Text style={estilo.textinho}>Conteúdo relevante</Text>
          </Pressable>
          <Pressable style={estilo.butao}>
            <Text style={estilo.textinho}>Questões</Text>
          </Pressable>
        </View>
        <View>
